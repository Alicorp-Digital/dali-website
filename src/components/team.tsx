...
export default function Team() {
  ...
  return (
    <div className='mb-4' >
      ...
      <ul style={{'maxWidth': '890px', 'margin': 'auto', 'flexWrap': 'wrap', 'justifyContent': 'center'}} className='d-flex list-group'>
        {
          data.map((item, index) => (
            <li className='mb-4 team-member' key={index}>
              <img height={80} width={80} className="rounded-circle mb-1" src={item.image} />
